...
/**
 * Konto: alle Login-/Anmelde-Cards (CAS, LSF-Stundenplan, LSF-Kurse,
 * IMAP-Credentials). Eigene Snackbar-Instanz, damit `viewModel.message`
 * direkt hier landet — der Hub-Screen ist beim Sub-Screen-Besuch nicht im
 * Compose-Tree.
 */
@Composable
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.fillMaxSize().padding(padding)) {
            HiUniTopBar(
                title = "Konto",
                onBack = onBack,
                subtitle = "Logins und Zugangsdaten"
            )
            LazyColumn(
